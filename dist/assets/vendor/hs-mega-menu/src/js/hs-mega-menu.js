/*
* HSMegaMenu Plugin
* @version: 2.0.1 (Sun, 1 Nov 2023)
* @author: UHS
* @event-namespace: .HSMegaMenu
* @license: UHS Libraries (https://UHS.com/)
* Copyright 2023 UHS
*/
  ...
  _init() {
    ...
    for (let i = 0; i < that.collection.length; i += 1) {
      ...
      document.addEventListener('keyup', e => {
        if (!e.target.closest(`${_options.classMap.hasMegaMenu}, ${_options.classMap.hasSubMenu}`) || e.target.closest('input')) return false
